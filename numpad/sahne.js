...
//----------------------------------------------Numpad ile  klavyeyi birleştir-----------------
		"<table class=\"klavye\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">",
//Klavye tusları satır1
            "<tr>",
  			    "<td><input type=\"button\" name=\"nmnumlock\" value=\"N/L\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmbolu\" value=\"/\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmcarpi\" value=\"*\" class=\"standart\"/></td>",
				"<td><input type=\"button\" name=\"nmeksi\" value=\"-\" class=\"standart\"/></td>",
			"</tr>",
			"<tr>",
                "<td><input type=\"button\" name=\"nmyedi\" value=\"7\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmsekiz\" value=\"8\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmdokuz\" value=\"9\" class=\"standart\"/></td>",
                "<td rowspan=\"2\"><input type=\"button\" name=\"nmarti\" value=\"+\" class=\"uzuntus\"/></td>",				
            "</tr>",
			"<tr>",
				"<td><input type=\"button\" name=\"nmdort\" value=\"4\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmbes\" value=\"5\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmalti\" value=\"6\" class=\"standart\"/></td>",
            "</tr>",
			"<tr>",
                "<td><input type=\"button\" name=\"nmbir\" value=\"1\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmiki\" value=\"2\" class=\"standart\"/></td>",
                "<td><input type=\"button\" name=\"nmuc\" value=\"3\" class=\"standart\"/></td>",
                "<td rowspan=\"2\"><input type=\"button\" name=\"nmgiris4\" value=\"Ent\" class=\"uzuntus\"/></td>",
            "</tr>",
			"<tr>",
                "<td colspan=\"2\"><input type=\"button\" name=\"nmsifir\" value=\"0\" class=\"genistus\"/></td>",
                "<td><input type=\"button\" name=\"nmvirgul\" value=\",\" class=\"standart\"/></td>",
            "</tr>",
        "</table>",
"</td></tr></table>",
   ...
   //---------------
         "<table width=\"70%\" border=\"1\">",
            ...
            "<tr>",
                "<td colspan=\"2\">",
	"<object classid=\"clsid:d27cdb6e-ae6d-11cf-96b8-444553540000\" codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0\" width=\"180\" height=\"174\" id=\"speedo1\" align=\"middle\">",
        "<param name=\"allowScriptAccess\" value=\"sameDomain\" />",
	"<param name=\"allowFullScreen\" value=\"false\" />",
	"<param name=\"movie\" value=\"../grafik-demo/speedo1.swf\" /><param name=\"quality\" value=\"high\" /><param name=\"bgcolor\" value=\"#ffffff\" />	<embed src=\"../grafik-demo/speedo1.swf\" quality=\"high\" bgcolor=\"#ffffff\" width=\"180\" height=\"174\" name=\"speedo1\" align=\"middle\" allowScriptAccess=\"sameDomain\" allowFullScreen=\"false\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.adobe.com/go/getflashplayer\" />",
	"</object>",
                "</td>",
            "</tr>",
         "</table>",
   ...
   //---------------
        "<table>",
            "<tr>",
                 "<td><input type=\"edit\" name=\"okumafisi\" class=\"disabled okumafis\" disabled=\"disabled\"/></td>",
                 "<td><div id=\"yazmafisi_satirsonu\" class=\"yazmafisi_satirsonu\">&nbsp;</div></td>",
            "</tr>",
            "<tr>",
                 "<td colspan=\"2\"><input type=\"edit\" name=\"yazmafisi\" class=\"disabled yazmafis\" disabled=\"disabled\" onkeypress=\"return yenitus(event)\"/></td>",
            "</tr>",
        "</table>",
   //---------------
   "</td></tr></table>",
