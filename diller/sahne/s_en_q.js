...
if (navigator.appName=="Microsoft Internet Explorer") {
	strGiris="<input type=\"button\" name=\"giris\" value=\"Enter\" class=\"giris\"/>";
}else{
	strGiris="<input type=\"button\" name=\"giris\" value=\"&#8629;\" class=\"giris\"/>";
}
...
//Klavye tusları satır2
            "<tr>",
                "<td nowrap=\"nowrap\">",
                    "<input type=\"button\" name=\"kesme\" value=\"’\" class=\"standart\"/>",
                    ...
                    "<input type=\"button\" name=\"esittir\" value=\"=\" class=\"standart\"/>",
...
//Klavye tusları satır3
            "<tr>",
                "<td nowrap=\"nowrap\">",
                    ...
                    "<input type=\"button\" name=\"kp_ac\" value=\"[\" class=\"standart\"/>",
                    "<input type=\"button\" name=\"kp_kapa\" value=\"]\" class=\"standart\"/>",
		    "<input type=\"button\" name=\"backslash\" value=\"&#92;\" class=\"sekme\"/>",
		"</nobr></td>",
            "</tr>",
//Klavye tusları satır4
            "<tr>",
                "<td nowrap=\"nowrap\">",
                    ...
                    "<input type=\"button\" name=\"noktalivirgul\" value=\";\" class=\"standart\"/>",
                    "<input type=\"button\" name=\"tektirnak\" value=\"'\" class=\"standart\"/>",
                    strGiris,
               "</td>",
            "</tr>",
//Klavye tusları satır5
            "<tr>",
                "<td>",
                    ...
                    "<input type=\"button\" name=\"bolu\" value=\"/\" class=\"standart\"/>",
...
//----------------------------------------------Numpad ile  klavyeyi birleştir-----------------
		...
		"<img style=\"width:120px;float:center;\" src="+profil_resim+" alt=\"profil resmine ulaşılamadı.\">",
            ...
            "<tr>",
                "<td><font color=\"blue\">Lesson</font></td>",
                "<td colspan=\"2\" valign=\"top\" bgcolor=\"blue\">",
                    "<div id=\"dersler\"></div>",
                "</td>",
            "</tr>",
            "<tr>",
                "<td rowspan=\"2\"><font color=\"red\">Correctness<br>Right keypress percent</font></td><td  valign=\"top\" bgcolor=\"red\"><input type=\"edit\" name=\"dogruluk_yuzdesi\" size=\"5\" value=\"0\"/></td>",
            "</tr>",
            "<tr>",
                "<td>Limit=95</td>",
            "</tr>",
            "<tr>",
                "<td rowspan=\"2\"><font color=\"green\">Speed<br>Characters per minute</font></td><td bgcolor=\"green\" valign=\"top\"><input type=\"edit\" name=\"hizlilik\" size=\"5\" value=\"0\"/></td>",
            "</tr>",
            "<tr>",
                "<td>Limit=100</td>",
            "</tr>",
