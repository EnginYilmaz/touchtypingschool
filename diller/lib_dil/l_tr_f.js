...
function sag_el_listesi() {
	var sag_el_karakter= new Array ("1","2","3","4","5","6","F","G","Ğ","I","U","İ","E","A","Ü","J","Ö","V","C",">","!","'","^","+","%","&");
	return sag_el_karakter; 
}

function sol_el_listesi () {
	var sol_el_karakter= new Array ("7","8","9","0","D","R","N","H","P","Q","W","T","K","M","L","Y","Ş","X","Z","S","B",";",":","/","(",")","=","?","_");
    ...
    sonrakikod= sonrakikarakter.charCodeAt(0);
     ...
     switch(sonrakikod) {
        ...
        case 43:document.klavye.dort.style.background='#c98321';
                document.klavye.dort.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sol_isaret"].src="grafikler/sol_isaret_sari.jpg";
                break;
        ...
        case 113:document.klavye.Q.style.background='#c98321';
                 document.klavye.Q.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sagserce_sari.jpg";
                 break;
     ...
     if (oncekikod==null)return 0;
 	 ...
 	 switch(oncekikod) {
        ...
        case 43:document.klavye.dort.style.background='black';
                document.klavye.dort.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sol_isaret"].src="grafikler/sol_isaret.jpg";
                break;
        ...
        case 113:document.klavye.Q.style.background='black';
                 document.klavye.Q.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sagserce.jpg";
                 break;
