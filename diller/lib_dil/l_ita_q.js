...
function sag_el_listesi() {
	var sag_el_karakter= new Array ("1","2","3","4","5","6","Q","W","E","R","T","Y","A","S","D","F","G","<","Z","X","C","V","B","&#92;","|", "!", "”",  "£","$","%","&");
	return sag_el_karakter; 
}

function sol_el_listesi () {
	var sol_el_karakter= new Array ("7","8","9","0","Y","U","I","O", "P","é", "+", "H","J","K","L", "ç","§","N","M",";",":","_","è","+","ò","à","ù",",",".","-");
    ...
    sonrakikod= sonrakikarakter.charCodeAt(0);
     switch(sonrakikod) {
        ...
        case 34:document.klavye.ciftirnak.style.background='#c98321';
                ...
                document["sol_serce"].src= temel_url + "grafikler/sol_serce_sari.jpg";
                break;
        case 35:document.klavye.diyez.style.background='#c98321';
                document.klavye.diyez.style.backgroundImage="url('grafikler/standart-bg.png')";
        ...
        case 41:document.klavye.dokuz.style.background='#c98321';
                ...
                break;
        case 42:document.klavye.arti.style.background='#c98321';
                document.klavye.arti.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                break;
        case 43:document.klavye.arti.style.background='#c98321';
                document.klavye.arti.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_serce"].src="./sag_serce_sari.jpg";
                break;
        ...
        case 56:document.klavye.sekiz.style.background='#c98321';
                document.klavye.sekiz.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_orta"].src= temel_url + "grafikler/sag_orta_yeni_sari.jpg";
                break;
        ...
        case 127:document.klavye.del.style.background='#c98321';
                 ...
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                 break;
        case 223:document.klavye.bb.style.background='#c98321';
                 document.klavye.bb.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                 break;
        case 228:document.klavye.aa.style.background='#c98321';
                 document.klavye.aa.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                 break;
        case 196:document.klavye.aa.style.background='#c98321';
                 document.klavye.aa.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                 break;
...
function onceki_tusu_sondur(){
     ...
     switch(oncekikod) {
        ...
        case 34:document.klavye.ciftirnak.style.background='black';
                ...
                document["sol_serce"].src= temel_url + "grafikler/sol_serce.jpg";
                break;
        case 35:document.klavye.diyez.style.background='black';
                document.klavye.diyez.style.backgroundImage="url('grafikler/standart-bg.png')";
        ...
        case 41:document.klavye.dokuz.style.background='black';
                ...
                break;
        case 42:document.klavye.arti.style.background='black';
                document.klavye.arti.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                break;
        case 43:document.klavye.arti.style.background='black';
                document.klavye.arti.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_serce"].src="./sag_serce.jpg";
                break;
        ...
        case 127:document.klavye.del.style.background='black';
                 ...
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                 break;
        case 223:document.klavye.bb.style.background='black';
                 document.klavye.bb.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                 break;
        case 228:document.klavye.aa.style.background='black';
                 document.klavye.aa.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                 break;
        case 196:document.klavye.aa.style.background='black';
                 document.klavye.aa.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                 break;
