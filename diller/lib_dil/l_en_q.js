function satir_sonu_tusu_turu_belirle () {
	satir_sonu_tusu_turu=1 // eğer ingilizce klavye gibi ince enter ise bayrak =1 eğer turkce q daki gibi ise bayrak=3 tur. 3 parcali vaya tek parcali 		anlaminda. on tanimli olarak 3 parcali turkce q daki gibi buyuk enter tusu secilidir.
}
    ...
    sonrakikod= sonrakikarakter.charCodeAt(0);
     switch(sonrakikod) {
        ...
        case 34:document.klavye.tektirnak.style.background='#c98321';
                document.klavye.tektirnak.style.backgroundImage="url('grafikler/standart-bg.png')";
        ...
        case 43:document.klavye.esittir.style.background='#c98321';
                document.klavye.esittir.style.backgroundImage="url('grafikler/standart-bg.png')";
        ...
        case 47:document.klavye.bolu.style.background='#c98321';
                document.klavye.bolu.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                break;
        ...
        case 91:document.klavye.kp_ac.style.background='#c98321';
                document.klavye.kp_ac.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                break;
        ...
        case 93:document.klavye.kp_kapa.style.background='#c98321';
                document.klavye.kp_kapa.style.backgroundImage="url('grafikler/standart-bg.png')";
                document["sag_yuzuk"].src= temel_url + "grafikler/sag_yuzuk_sari.jpg";
                break;
        ...
        case 58:document.klavye.noktalivirgul.style.background='#c98321';
                 document.klavye.noktalivirgul.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce_sari.jpg";
                 break;
...
function onceki_tusu_sondur(){
     ...
     switch(oncekikod) {
        ...
        case 127:document.klavye.del.style.background='black';
                 ...
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                 break;
        case 287:document.klavye.kp_ac.style.background='black';
                 document.klavye.kp_ac.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                 break;
        case 286:document.klavye.kp_ac.style.background='black';
                 document.klavye.kp_ac.style.backgroundImage="url('grafikler/standart-bg.png')";
                 document["sag_serce"].src= temel_url + "grafikler/sag_serce.jpg";
                 break;
        case 93:document.klavye.kp_kapa.style.background='black';
